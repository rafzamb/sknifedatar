...
`r automagic_tabs(input_data = nest_data, panel_name = "sector", .output = "ts_plots", fig.heigth=1, fig.width=10, echo = FALSE)`
...
`r automagic_tabs(input_data = data_filter, panel_name = "sector", .output = "STL", fig.height=5.5, .layout = "l-body-outset", echo = FALSE)`
...
`r automagic_tabs(input_data = data_filter , panel_name = "sector", .output = "ACF",.layout="l-body-outset", echo = FALSE)`
